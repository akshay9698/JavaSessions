package superKeyword;
	...
	public class Car extends Vehicle {
		...
		// 4. if child class has overridden method (start), now If I want to call parent
		// class (start) method:
		// we have to super.start()
		// 5. if immediate parent class has not vars/methods, super can be used to call
		// methods/vars from grandparent.
