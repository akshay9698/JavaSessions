...
public class Employee {
	...
	// constructor:
	// const... name will be same as the class name but function name could be
	// anything
	// it looks like a function but its not a function
	// const.. can not return anything, can not be void also -- there is no return
	// but function may or may not return
	// avoid buss logic in const...but function should have the buss logic

	// const.. is used to initialize the class (instance) variables with the help of
	// local variables using this keyword

	// const.. can be overloaded, same with function also

	// const.. will be called automatically when we create the object of the class
	// but function will be called using the object ref name or static function will
