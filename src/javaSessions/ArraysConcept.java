...
public class ArraysConcept {
	...
	public static void main(String[] args) {
		...
		// 1. size is fixed(static array): to overcome this, we use ArrayList(Dynamic
		// Array)
		// 2. can store only similar data types: to overcome this, we can use Object
		// array but this still a static array
